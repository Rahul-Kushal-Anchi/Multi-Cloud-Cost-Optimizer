...
SECRET_KEY = os.getenv("APP_JWT_SECRET", "CHANGE_ME_IN_PRODUCTION")  # set in ECS/Secrets Manager
ALGO = "HS256"
...
def create_access_token(email: str, user_id: int, role: str = "admin", tenant_id: Optional[int] = None) -> str:
